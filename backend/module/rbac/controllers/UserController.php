...
use backend\module\rbac\models\User as UserSearch;
use backend\module\rbac\models\SignupForm;
...
//Common::p(Yii::$app->getCache()->get('rbac'));
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            }else if($model->load($request->post()) && $model->validate() && $model->signup()){
                return [
    ...
    public function actionUpdate($id)
    {
        $request = Yii::$app->request;
        $model = $this->findModel($id);  
        $model->role = Role::getRoleNameByUid($id);
        
        if($request->isAjax){
            /*
            *   Process for ajax request
            */
            $model->scenario = 'Supdate';
            Yii::$app->response->format = Response::FORMAT_JSON;
            if($request->isGet){
                return [
...
//             $model->delete();
//         }
        $model = User::updateAll($attributes);
