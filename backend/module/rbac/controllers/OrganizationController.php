...
use backend\module\rbac\models\OrganizationSearch;
...
class OrganizationController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel->created_at = Yii::$app->request->get('OrganizationSearch')['created_at'];
    ...
    public function actionBulkDelete()
    {
        ...
        foreach (Organization::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
