...
class  MenuController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $model = $this->findModel($id);
        $model->scenario = 'uc';
        $preLevelMenu = AuthMenuSearch::getLevelMenu($model->level-1);
        $preLevelMenu = array_column($preLevelMenu, 'name', 'id');
    ...
    {        
        ...
        die($pks);
        foreach (AuthMenu::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
    ...
    public function actionGetmenu()
    {
        ...
        if($request->isAjax){
            ...
            $preLevelMenu = AuthMenuSearch::getLevelMenu($level-1);
